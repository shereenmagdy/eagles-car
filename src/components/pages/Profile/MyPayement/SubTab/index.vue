...
let AccountListIcons = ref([
  {
    id: 0,
    image_icon: new URL(
      `@/assets/images/global/icons/global/profile/percentage-square.svg`,
      import.meta.url
    ).href,
    image_icon_active: new URL(
      `@/assets/images/global/icons/global/profile/percentage-square-active.svg`,
      import.meta.url
    ).href,
    title: "Promotions",
  },
  {
    id: 1,
    image_icon: new URL(
      `@/assets/images/global/icons/global/profile/empty-wallet-change.svg`,
      import.meta.url
    ).href,
    image_icon_active: new URL(
      `@/assets/images/global/icons/global/profile/empty-wallet-change-active.svg`,
      import.meta.url
    ).href,
    title: "Payement",
  },
