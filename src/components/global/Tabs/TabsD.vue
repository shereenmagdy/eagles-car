...
const props = defineProps(["buttons", "selectedTab", "data"]);
    ...
    <section class="nice-navigator">
      <ul ref="list">
        ...
        >
          <button
            :name="button.name"
            :class="buttonName == button.name ? 'active' : ''"
          >
...
.is-en {
  .tabs .nice-navigator ul li:first-child button {
    border-radius: 8px 0px 0px 8px;
  }
  .tabs .nice-navigator ul li:last-child button {
    border-radius: 0px 8px 8px 0px;
  }
}
</style>
