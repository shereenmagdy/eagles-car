<template>
  <div class="vtl vtl-card">
    ...
    <div class="vtl-card-body">
      ...
      <div class="vtl-paging vtl-row row" v-if="rows.length > 0">
        <template v-if="!setting.isHidePaging">
          <div class="vtl-paging-info col-md-6 mt-2">
          ...
          <div class="vtl-paging-pagination-div col-md-6">
              ...
              <ul class="vtl-paging-pagination-ul vtl-pagination">
                ...
                >
                  ...
                  >
                    <span aria-hidden="true"
                      ><img
                        src="@/assets/images/global/icons/suppliers/arrow-right-d.png"
                        width="20"
                    /></span>
                ...
                >
                  ...
                  >
                    <span aria-hidden="true" class="d-flex align-items-center"
                      ><img
                        src="@/assets/images/global/icons/suppliers/arrow-right-s.png"
                        width="14"
                    /></span>
                ...
                >
                  ...
                  >
                    <span aria-hidden="true" class="d-flex align-items-center"
                      ><img
                        src="@/assets/images/global/icons/suppliers/arrow-left-s.png"
                        width="14"
                    /></span>
                ...
                >
                  ...
                  >
                    <span aria-hidden="true" class="d-flex align-items-center"
                      ><img
                        src="@/assets/images/global/icons/suppliers/arrow-left-d.png"
                        width="20"
                    /></span>
...
.vtl-both {
  background-image: url(../../../assets/images/global/icons/global/arrow-swap.svg);
...
.vtl-table-responsive {
  ...
  background: white;
  box-shadow: 4px 4px 11px rgba(205, 200, 200, 0.6784313725);
}
.noShadow .vtl-table-responsive {
  box-shadow: none;
}
...
@media (min-width: 576px) {
  ...
  // .inlineTable .vtl-table-responsive-sm {
  //   display: inline-table;
  // }
